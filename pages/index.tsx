      ...
      <div id="about" className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
          ...
          <div className="lg:mt-16 sm:mt-12 mt-16 flex lg:flex-row justify-between flex-col lg:gap-8 gap-12">
            <div className="w-full xl:w-5/12 lg:w-6/12">
                ...
                <p className="font-normal text-base leading-6 text-gray-600 mt-4">PAANEN makes you obtain NFT but not with selling unique paintings or drawings, instead with the certificate that the user got from minting, which contains the name of the harvest product and the village from which the product originates, the name of the ongoing event, and the edition of the event, the weight of the harvest, and the QR code for the submission data filling form.</p>
